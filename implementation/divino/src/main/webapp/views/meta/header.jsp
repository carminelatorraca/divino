...
<% DataSource headerDs = (DataSource) pageContext.getServletContext().getAttribute("DataSource"); %>
<% CategoriesDAO headerCatDAO = new CategoriesDAO(headerDs); %>
...
<nav class="navbar navbar-expand-md navbar-dark bg-black wine-header">
    <div class="container-fluid">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/shop.jsp">
            <img src="${pageContext.request.contextPath}/media/logo.png" alt="logo" width="50" height="50">
        </a>
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="offcanvasNavbarDropdown" style="border-radius: 0">
                            <% Collection<?> categories = null;
                                try {
                                    categories = headerCatDAO.getAll("categoryName");
                                } catch (SQLException ex) {
                                    ex.printStackTrace();
                                }
                                Iterator<?> catIterator = categories.iterator();
                                while (catIterator.hasNext()) {
                                    Categories category = (Categories) catIterator.next();
                            %>
                            <li>
                    ...
                    %>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/account/account.jsp">Il mio account</a>
                    </li>
                    <%
                        } else {
                    %>
